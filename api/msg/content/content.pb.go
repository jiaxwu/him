...
type Image struct {
	...
	Type   ImageType `protobuf:"varint,4,opt,name=Type,proto3,enum=msg.content.ImageType" json:"Type,omitempty"` // 图片类型
...
type Voice struct {
	...
	Type     VoiceType `protobuf:"varint,3,opt,name=Type,proto3,enum=msg.content.VoiceType" json:"Type,omitempty"` // 语音类型
...
type Video struct {
	...
	URL      string    `protobuf:"bytes,1,opt,name=URL,proto3" json:"URL,omitempty"`                               // 地址
	Duration uint32    `protobuf:"varint,2,opt,name=Duration,proto3" json:"Duration,omitempty"`                    // 时长，单位秒
	Type     VideoType `protobuf:"varint,3,opt,name=Type,proto3,enum=msg.content.VideoType" json:"Type,omitempty"` // 视频类型
	Size     uint32    `protobuf:"varint,4,opt,name=Size,proto3" json:"Size,omitempty"`                            // 大小，单位B
}
...
type File struct {
	...
	Type FileType `protobuf:"varint,3,opt,name=Type,proto3,enum=msg.content.FileType" json:"Type,omitempty"` // 文件类型
	Size uint32   `protobuf:"varint,4,opt,name=Size,proto3" json:"Size,omitempty"`                           // 大小，单位B
}
...
var file_api_msg_content_content_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x16, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	...
	0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x6a, 0x0a, 0x0f, 0x4e, 0x69, 0x63,
	...
	,
...
var file_api_msg_content_content_proto_goTypes = []interface{}{
	(ImageType)(0),          // 0: msg.content.ImageType
	(VoiceType)(0),          // 1: msg.content.VoiceType
	(VideoType)(0),          // 2: msg.content.VideoType
	(TipType)(0),            // 3: msg.content.TipType
	(FileType)(0),           // 4: msg.content.FileType
	(*Image)(nil),           // 5: msg.content.Image
	(*Voice)(nil),           // 6: msg.content.Voice
	(*Video)(nil),           // 7: msg.content.Video
	(*TextTip)(nil),         // 8: msg.content.TextTip
	(*NickNameTextTip)(nil), // 9: msg.content.NickNameTextTip
	(*NickNameText)(nil),    // 10: msg.content.NickNameText
	(*File)(nil),            // 11: msg.content.File
}
var file_api_msg_content_content_proto_depIdxs = []int32{
	0,  // 0: msg.content.Image.Type:type_name -> msg.content.ImageType
	1,  // 1: msg.content.Voice.Type:type_name -> msg.content.VoiceType
	2,  // 2: msg.content.Video.Type:type_name -> msg.content.VideoType
	10, // 3: msg.content.NickNameTextTip.NickNameTexts:type_name -> msg.content.NickNameText
	4,  // 4: msg.content.File.Type:type_name -> msg.content.FileType
